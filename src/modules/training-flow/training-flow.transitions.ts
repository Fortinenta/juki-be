...
export const TRAINING_FLOW_TRANSITIONS: Record<string, string[]> = {
  ...
  [TRAINING_STATUS.PAYMENT_WAITING]: [
    TRAINING_STATUS.PAYMENT_VERIFIED,
    TRAINING_STATUS.PAYMENT_REQUIRED, // Allow reject (back to upload)
  ],
  ...
  [TRAINING_STATUS.WAITING_ADMINISTRATIVE]: [
    TRAINING_STATUS.ARTICLE_WAITING,
    TRAINING_STATUS.ADMINISTRATIVE_REJECTED,
  ],

  [TRAINING_STATUS.ADMINISTRATIVE_REJECTED]: [TRAINING_STATUS.WAITING_ADMINISTRATIVE],
  ...
  [TRAINING_STATUS.TRAINING_RESCHEDULE]: [TRAINING_STATUS.TRAINING_WAITING],

  [TRAINING_STATUS.TRAINING_VERIFIED]: [
    TRAINING_STATUS.REVIEW_WAITING,
    TRAINING_STATUS.REVIEW_VERIFIED, // Allow direct accept
    TRAINING_STATUS.REVIEW_REVISION, // Allow direct revision
  ],
  ...
  [TRAINING_STATUS.REVIEW_REVISION]: [TRAINING_STATUS.REVIEW_WAITING],
