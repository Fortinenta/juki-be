...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('LOGIN', 'LOGOUT', 'REGISTER', 'UPDATE_PROFILE', 'UPDATE_PASSWORD', 'DELETE_ACCOUNT', 'REFRESH_TOKEN', 'REVOKE_TOKEN');
...
CREATE TABLE "user_training_flows" (
    ...
    CONSTRAINT "user_training_flows_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "user_training_flows_userId_key" ON "user_training_flows"("userId");
